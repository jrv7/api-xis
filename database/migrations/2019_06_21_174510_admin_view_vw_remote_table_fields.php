...
class AdminViewVwRemoteTableFields extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement("CREATE OR REPLACE VIEW admin.vw_remote_table_fields AS 
            SELECT 
    ...
    {
        DB::statement("DROP VIEW admin.vw_remote_table_fields");
    }
}
